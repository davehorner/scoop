...
.PARAMETER UseCache
    ...
    Should not be used, because check should be used for downloading actual version of file (as normal user, not finding in some document from vendors, which could be damaged / wrong (Example: Slack@3.3.1 davehorner/scoop-extras#1192)), not some previously downloaded.
.EXAMPLE
