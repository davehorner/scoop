...
# get core functions
$core_url = 'https://raw.githubusercontent.com/davehorner/scoop/master/lib/core.ps1'
...
# download scoop zip
$zipurl = 'https://github.com/davehorner/scoop/archive/master.zip'
...
$zipurl = 'https://github.com/davehorner/ScoopInstallerMain/archive/master.zip'
